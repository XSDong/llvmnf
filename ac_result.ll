...
declare dso_local void @jump(i32, i32) #0
...
entry:
  %nfv.jmp0.loop = alloca i32, align 4
  store i32 0, i32* %nfv.jmp0.loop, align 4
  %nfv.cond.pointer0 = alloca i32, align 4
  store i32 0, i32* %nfv.cond.pointer0, align 4
...
nfv.jmp0:
  %nfv.cond0 = load i32, i32* %nfv.cond.pointer0, align 4
  %nfv.jmp0.loop.address = load i32, i32* %nfv.jmp0.loop, align 4
  %nfv.jmp0.loop.inc = add nsw i32 %nfv.jmp0.loop.address, 1
  store i32 %nfv.jmp0.loop.inc, i32* %nfv.jmp0.loop, align 4
  call void @jump(i32 500, i32 %nfv.jmp0.loop.inc)
  call void @jump(i32 1000, i32 %nfv.jmp0.loop.inc)
