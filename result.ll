...
for.body3:                                        ; preds = %for.cond1
  ...
  %call8 = call i32 @c2i(i8 signext %9)
...
for.cond20:                                       ; preds = %for.inc26, %if.end
...
for.cond65:                                       ; preds = %for.inc88, %for.end62
...
for.cond70:                                       ; preds = %for.inc85, %for.body68
...
return:                                           ; preds = %if.end36, %cond.end, %if.then15, %if.then
...
if.end:                                           ; preds = %if.then3, %for.body
  ...
  call void @addRoundKey([4 x i32]* %11, [4 x i32]* %arraydecay5)
  br label %for.inc
...
if.else:                                          ; preds = %entry
  ...
  call void @addRoundKey([4 x i32]* %14, [4 x i32]* %arraydecay7)
...
for.body11:                                       ; preds = %for.cond9
  ...
  call void @addRoundKey([4 x i32]* %20, [4 x i32]* %arraydecay14)
...
if.then16:                                        ; preds = %for.body11
  ...
  call void @mixColumns([4 x i32]* %23, i32 %24)
  br label %if.end17
...
for.cond15:                                       ; preds = %for.inc123, %for.end13
  %11 = load i32, i32* %i14, align 4
  %cmp16 = icmp slt i32 %11, 11
  br i1 %cmp16, label %for.body17, label %for.end125

for.body17:                                       ; preds = %for.cond15
  store i32 0, i32* %j18, align 4
  br label %for.cond19

for.cond19:                                       ; preds = %for.inc120, %for.body17
...
for.cond46:                                       ; preds = %for.inc66, %if.then
...
if.end:                                           ; preds = %if.then58, %for.body48
  br label %for.inc66
...
if.end97:                                         ; preds = %if.else, %for.end68
  store i32 0, i32* %l, align 4
  br label %for.cond98

for.cond98:                                       ; preds = %for.inc117, %if.end97
...
if.then:                                          ; preds = %for.body
  ...
  %call11 = call i32 @aes_multiple(i32 %15, i32 3)
  ...
  %call17 = call i32 @aes_multiple(i32 %21, i32 2)
  %xor18 = xor i32 %20, %call17
  %22 = load i32, i32* %temp2, align 4
  %23 = load i32, i32* %temp2, align 4
  %call19 = call i32 @aes_multiple(i32 %23, i32 2)
  ...
  %call35 = call i32 @aes_multiple(i32 %35, i32 2)
  ...
  %call39 = call i32 @aes_multiple(i32 %38, i32 2)
...
if.else:                                          ; preds = %for.body
  ...
  %call44 = call i32 @aes_multiple(i32 %41, i32 14)
  %42 = load i32, i32* %temp1, align 4
  %call45 = call i32 @aes_multiple(i32 %42, i32 11)
  %xor46 = xor i32 %call44, %call45
  %43 = load i32, i32* %temp2, align 4
  %call47 = call i32 @aes_multiple(i32 %43, i32 13)
  %xor48 = xor i32 %xor46, %call47
  %44 = load i32, i32* %temp3, align 4
  %call49 = call i32 @aes_multiple(i32 %44, i32 9)
  ...
  %call54 = call i32 @aes_multiple(i32 %47, i32 9)
  %48 = load i32, i32* %temp1, align 4
  %call55 = call i32 @aes_multiple(i32 %48, i32 14)
  %xor56 = xor i32 %call54, %call55
  %49 = load i32, i32* %temp2, align 4
  %call57 = call i32 @aes_multiple(i32 %49, i32 11)
  %xor58 = xor i32 %xor56, %call57
  %50 = load i32, i32* %temp3, align 4
  %call59 = call i32 @aes_multiple(i32 %50, i32 13)
  ...
  %call64 = call i32 @aes_multiple(i32 %53, i32 13)
  %54 = load i32, i32* %temp1, align 4
  %call65 = call i32 @aes_multiple(i32 %54, i32 9)
  %xor66 = xor i32 %call64, %call65
  %55 = load i32, i32* %temp2, align 4
  %call67 = call i32 @aes_multiple(i32 %55, i32 14)
  %xor68 = xor i32 %xor66, %call67
  %56 = load i32, i32* %temp3, align 4
  %call69 = call i32 @aes_multiple(i32 %56, i32 11)
  ...
  %call74 = call i32 @aes_multiple(i32 %59, i32 11)
  %60 = load i32, i32* %temp1, align 4
  %call75 = call i32 @aes_multiple(i32 %60, i32 13)
  %xor76 = xor i32 %call74, %call75
  %61 = load i32, i32* %temp2, align 4
  %call77 = call i32 @aes_multiple(i32 %61, i32 9)
  %xor78 = xor i32 %xor76, %call77
  %62 = load i32, i32* %temp3, align 4
  %call79 = call i32 @aes_multiple(i32 %62, i32 14)
...
if.end25:                                         ; preds = %for.end22, %if.end7
...
if.end36:                                         ; preds = %if.end33, %if.end25
